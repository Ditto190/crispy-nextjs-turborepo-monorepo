---
name: code-management-git-commit-convention-conventional-commits
description: Imported TRAE skill from code_management/Git_Commit_Convention_Conventional_Commits.md
---
